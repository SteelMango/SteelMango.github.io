...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["DNSSEC".freeze, "EVENTMACHINE".freeze, "EXAMPLES".freeze, "README.md".freeze]
  ...
  s.add_development_dependency(%q<rdoc>.freeze, [">= 6.5".freeze, "< 8.0".freeze])
