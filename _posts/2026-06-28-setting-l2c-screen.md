...
I lied, the screen is actually £3.46 upon editing this post. I was scrolling through Aliexpress for cheap components for my ESP32 and found this, a LCD Display module for £3. Since we don't want to solder, make sure to choose the IIC LCD1602. Why?, Because the display module has a little backpack called an ICC. An ICC module helps reduce the amount of wires to connect to the display and additionally allows us to use jumper wires (male to female/female to female). Without the ICC we would need to solder the display module.
